            ...
            setup_layout = function () { 
                ...
                overview = d3.select( "#pubVis" )
                                        ...
                                        .attr({
                                            id: "overview",
                                            //width: width,
                                            //height: svg_height //includes space between header and overivew
                                        })
...
//                    actual_year = new Date().getFullYear();
        ...
        //****************************HEADER******************************//
            var HEADER = function(color){
                ...
                var home_link = "https://github.com/cgiohidalgo/SASR";
                ...
                var create_bar_chart = function ( params ){ 
                    ...
                    chart.set_svg_group = function ( params ) { 
                        ...
                        group = d3.select( "#overview" )
                                .append("g")
                                .attr( "id", id )
                                .attr("transform", "translate(" + transform_xPos + "," + transform_xPos + ")"); //move x,y of whole svg.chart
                    }
            ...
            var BAR_YEARS = function () {
                ...
                var create_bar_years = function ( params ) {            
                    ...
                    new_bar_years.set_svg_group({ id:"chart", 
                                            ...
                                            transform_xPos: (new_bar_years.get_margins().left) //because it don't includes the space between header and overview
                                          });            
            ...
            var AMOUNT = function ( params ) {
               ...
               /* if ( ( max_number_of_bars === 10 ) ) { //so max_number_of_bars will be 10
                ...
                var total_amount = amount.append( "text" )
                                    ...
                                    .text ( "Your file contains "+total_nb+" data" )
                                    .attr({
                                            x: xPos_amount,
                                            y: 125, 
                                            fill: color_text,
                ...
                function generate(sortBy) {
                    ...
                    function subgenerate() {
                        ...
                        if (data[j].entryTags['abstract'] != undefined || details !== ""){
                            arrow = "<svg version='1.1' id='Ebene_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' width='22px' height='22px' viewBox='0 0 22 22' enable-background='new 0 0 22 22' xml:space='preserve' class='download'><g transform='rotate(0, 0, 0)')><path fill='#333333' d='M11.31,5.236l-4.161,8.315l-4.16-8.315H11.31z'/></g></svg>";
                        } else {
                            arrow = "&nbsp";
                        }
